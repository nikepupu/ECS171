...
nodes = 9; % number of node per hidden layer;
load data.txt;
rng(200)
...
fprintf('Problem#5\nPlug in the number from Q5 into the w obtained from 9 nodes\nPlease make sure that we are using 9 nodes\n')
test = [0.50 0.49 0.52 0.20 0.55 0.03 0.50 0.39]';
...
[M, indice] = max(a3);
fprintf('The prediction is the %dth class', indice)
